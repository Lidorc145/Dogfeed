    ...
    render() {
        ...
        return (React.createElement(View, { style: style },
            React.createElement(View, { onLayout: this._onLayout, ref: this.pickerContainer, style: styles.pickerContainer }, !pickerSize ? null : (React.createElement(View, null,
                React.createElement(View, { key: rotationHack, style: [styles.triangleContainer, computed.triangleContainer] },
                    React.createElement(View, { style: [styles.triangleUnderlayingColor, computed.triangleUnderlayingColor] }),
                    React.createElement(Image, { style: [styles.triangleImage, computed.triangleImage], source: require('./resources/hsv_triangle_mask.png') })),
                React.createElement(View, Object.assign({}, this._pickerResponder.panHandlers, { style: [styles.picker, computed.picker], collapsable: false }),
                    ...
                    React.createElement(View, { key: rotationHack, style: [styles.pickerIndicator, computed.pickerIndicator] },
                        React.createElement(View, { style: [styles.pickerIndicatorTick, computed.pickerIndicatorTick] })),
                    React.createElement(View, { style: [styles.svIndicator, computed.svIndicator] }))))),
            React.createElement(View, { style: [styles.colorPreviews, computed.colorPreviews] },
                oldColor && (React.createElement(TouchableOpacity, { style: [styles.colorPreview, { backgroundColor: oldColor }], onPress: this._onOldColorSelected, activeOpacity: 0.7 })),
                React.createElement(TouchableOpacity, { style: [styles.colorPreview, { backgroundColor: selectedColor }], onPress: this._onColorSelected, activeOpacity: 0.7 }))));
    }
}
